...
public class RoundTrip extends OneWayTrip {
	...
	public void setLoc_departuresortby_option_btn() {
		this.loc_departuresortby_option_btn = property.getProperty("(//p[@class='inlineB marL10 sortbytype'])[2]");
	}
	...
	public void setLoc_returnsortby_option_btn() {
		this.loc_returnsortby_option_btn = productName.getProperty("(//p[@class='inlineB marL10 sortbytype'])[1]");
	}
